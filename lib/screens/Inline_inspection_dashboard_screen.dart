...
class _MachineStatusScreenState extends State<MachineStatusScreen> {
  ...
  List<String> get _machines =>
      _selectedLine != null ? _lineMachines[_selectedLine!] ?? [] : [];
  ...
  void _showMachineDetails(String machineId) {
    ...
    final statusCounts =
        _machineStatusCounts[machineId] ??
              ...
              if (faults.isNotEmpty) ...[
                ...
                ...faults.map(
                  (fault) => GestureDetector(
                    onLongPress: () => _showFixFaultDialog(machineId, fault),
                    child: Container(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          "INLINE INSPECTION  DENIM - ${_authService.currentUser?.fullName ?? 'Machine Status'}",
        ...
        child: _showInspectionForm
            ? InspectionForm(
                ...
                isMaintenanceInspection:
                    _machineCurrentStatus[_selectedMachine!] == "blue",
              )
            : (_selectedLine == null
      ...
      floatingActionButton:
          _selectedLine != null && _currentView == 0 && !_showInspectionForm
          ? _buildStatusButtons()
          : null,
    );
  }
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 10),
            Text(
              "Assigned Line: ${_authService.currentUser?.assignedLine ?? 'Not assigned'}",
  ...
  Widget _buildTrafficLightView() {
    ...
    final statusCounts =
        _machineStatusCounts[_selectedMachine] ??
        {"red": 0, "yellow": 0, "green": 0, "blue": 0};
                        ...
                        child: Column(
                          ...
                          children: [
                            Row(
                              children: [
                                Icon(
                                  _getMachineIcon(_selectedMachine!),
                            ...
                            const SizedBox(height: 10),
                            Text(
                              "Inspection: ${_inspectionType == "Auto" ? "Auto ($_inspectionPieces pieces)" : "Round ($_roundCount)"}",
                            ),
                              ...
                              child: ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  return GestureDetector(
                                    onLongPress: () => _showFixFaultDialog(
                                      _selectedMachine!,
                                      fault,
                                    ),
                                    child: Container(
                ...
                : GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return GestureDetector(
                        ...
                        // Click for details only
                        onLongPress: () {
                          _selectMachine(machine);
                          setState(() {
                            _showInspectionForm =
                                true; // Long press for inspection
                          });
                        },
                        child: Container(
  ...
  Widget _buildStatusButtons() {
    return Container(
      ...
      child: Row(
        ...
        children: [
         */
/* _buildStatusButton("Red", "red", Colors.red[700]!),
          const SizedBox(width: 12),
          _buildStatusButton("Yellow", "yellow", Colors.amber[600]!),
          const SizedBox(width: 12),
          _buildStatusButton("Green", "green", Colors.green[600]!),
          const SizedBox(width: 12),
*//*

          _buildStatusButton("Blue", "blue", Colors.blue[600]!),
        ],
      ),
    );
  }
